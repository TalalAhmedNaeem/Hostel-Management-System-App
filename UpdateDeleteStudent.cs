...
namespace Hostel_Management_System_GUI_App__
{
    public partial class UpdateDeleteStudent : Form
    {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            query = "update newStudent set name = '"+name+"',fname = '"+fname+"',mname = '"+mname+"',email = '"+email+"',paddress = '"+paddress+"',college = '"+college+"',idproof='"+idproof+"',roomNo="+roomNo+",living='"+livingStatus+"' where mobile ="+mobile+" update allroom set Booked = '"+livingStatus+"' where roomNo="+roomNo+" ";
